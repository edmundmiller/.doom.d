;;; doom-ayu-light-theme.el --- inspired by Atom Ayu Light -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
(def-doom-theme doom-ayu-light
  "A light theme inspired by Atom Ayu"
  ...
  ((bg         '("#fafafa" nil       nil))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-ayu-light-brighter-comments cyan base4))
  ...
  ((centaur-tabs-unselected :background bg-alt :foreground base4)
   (font-lock-comment-face
    :foreground comments
    :background (if doom-ayu-light-comment-bg base0))
   (font-lock-doc-face
