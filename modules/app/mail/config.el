...
(def-package! notmuch
  ...
  (set! set-evil-initial-state! 'notmuch-hello-mode 'normal)
  (set! set-evil-initial-state! 'notmuch-show-mode 'normal)
  (set! set-evil-initial-state! 'notmuch-search-mode 'normal)
  (set! set-evil-initial-state! 'notmuch-tree-mode 'normal)
  (set! set-evil-initial-state! 'notmuch-message-mode 'normal)
