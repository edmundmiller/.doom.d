...
(after! org
  (use-package! doct
    ...
    (setq org-capture-templates
          (append
           (doct '(("Appointment" :keys "a"
                    :function (expand-file-name "schedule.org" org-directory)
                    ;; :file "/home/emiller/sync/org/schedule.org"
                    :template ("* %?"
                               "%^T"
                               ":PROPERTIES:"
                               ":END:"))
                   ("Lab Entry" :keys "l"
                    :function (expand-file-name "Lab_Notebook.org" deft-directory)
                    :olp ("Lab Journal")
                    :+datetree t
                    :template ("* %?"
                               "%^g"
